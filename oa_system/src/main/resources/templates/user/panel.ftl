                            ...
                            <div class="post"
                                ...
                                <div class="user-block">
                                    <span class="papertitle"
                                          style="color: #8e8e8e;margin-right: 8px;">${(notepaper.title)!''}</span>
                                    <a href="notepaper?id=${notepaper.notepaperId}"
                                       onclick="{return confirm('删除该记录将不能恢复，确定删除吗？');};"
                                       id="paperdelete" class="pull-right ">
                                        <i class='glyphicon glyphicon-remove-sign'></i></a>
                                    <span class="papertime"
                                          style="font-size: 8pt; color: #999;">${notepaper.createTime}</span>
                                </div>
                                ...
                                <a style="margin-top: -22px;" class="pull-right edit" data-toggle="modal"
                                   data-target="#notepaper"
